...
enum PinType { IO_SERIAL_INPUT, IO_SR_CLOCK_INPUT, IO_PARALLEL_OUTPUT, IO_SERIAL_OUTPUT, IO_RESET_INPUT, IO_STORAGE_CLOCK_INPUT, IO_3STATE_INPUT, IO_GROUND, IO_VOLTAGE_EMITTER, IO_OTHER, MC_DIGITAL_IO, MC_DIGITAL_IO_POW /* for me only */, MC_GROUND, MC_VCC, MC_ANALOG_PIN, MC_ANALOG_REF, MC_RESET, MC_TXAL, MC_OTHER };
